...
@section('content')
    <div class="mx-auto max-w-xl">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="font-bold text-gray-800 text-2xl">Tambah Jenis Hewan</h1>
                <p class="text-gray-600">Tambahkan jenis hewan baru.</p>
            </div>
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-xl overflow-hidden">
            <form action="{{ route('jenis-hewan.store') }}" method="POST" class="space-y-4 p-6">
                @csrf

                <!-- Nama Jenis Hewan -->
                <div>
                    <label for="nama_jenis_hewan" class="block mb-1 font-medium text-gray-700 text-sm">Nama Jenis
                        Hewan</label>
