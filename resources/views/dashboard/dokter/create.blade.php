...
@section('title', 'Tambah Dokter - RSHP UNAIR')

@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="font-bold text-gray-800 text-2xl">Tambah Dokter</h1>
                <p class="text-gray-600">Tambahkan data dokter baru.</p>
            </div>
        ...
        <div class="bg-white shadow-sm border border-gray-200 rounded-xl overflow-hidden">
            <form action="{{ route('dokter.store') }}" method="POST" class="space-y-4 p-6">
                @csrf

                <!-- Nama -->
                <div>
                    <label for="nama" class="block mb-1 font-medium text-gray-700 text-sm">Nama Dokter</label>
                ...
                <!-- Bidang Dokter -->
                <div>
                    <label for="bidang_dokter" class="block mb-1 font-medium text-gray-700 text-sm">Bidang Dokter</label>
                    <input type="text" name="bidang_dokter" id="bidang_dokter" value="{{ old('bidang_dokter') }}"
