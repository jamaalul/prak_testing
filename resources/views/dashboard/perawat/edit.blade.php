...
@section('title', 'Edit Perawat - RSHP UNAIR')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Edit Data Perawat</h1>
            <p class="text-gray-600">Perbarui informasi profesional perawat.</p>
        </div>
        <a href="{{ route('perawat.index') }}" class="flex items-center text-sm text-gray-500 hover:text-gray-700 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('perawat.update', $perawat->id_perawat) }}" method="POST" class="p-6 space-y-4">
            @csrf
            @method('PUT')

            <!-- Nama (User) -->
            <div>
                <label for="nama" class="block text-sm font-medium text-gray-700 mb-1">Nama Perawat</label>
